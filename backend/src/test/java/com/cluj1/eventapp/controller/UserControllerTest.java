...
class UserControllerTest {
        ...
        void updateUserProfile_WithValidImage_ShouldReturnOk() throws Exception {
                ...
                MockMultipartHttpServletRequestBuilder builder = MockMvcRequestBuilders.multipart("/api/users/profile");
        ...
        void updateUserProfile_WithInvalidFileType_ShouldReturn415() throws Exception {
                ...
                MockMultipartFile file = new MockMultipartFile(
                                "profilePicture", "test.pdf", MediaType.APPLICATION_PDF_VALUE,
